...
const App = () => (<Fragment>
        <Helmet
            ...
            rootAttributes={{'class': 'd-flex flex-column flex-root'}}
            bodyAttributes={{'class': 'header-fixed header-mobile-fixed subheader-enabled subheader-fixed'}}
        >
            <title>Can Acar' Blog</title>
...
[Logo]
                            ...
                            <div className={'header-menu header-menu-mobile header-menu-layout-default'}>
                                <ul className={'menu-nav'}>
                                    ...
                                    <li className={'menu-item menu-item-submenu menu-item-rel'}>
                                        <a href="#" className="menu-link menu-toggle">
                                            <span className="menu-text">Hakkımda</span>
                                            <i className="menu-arrow"></i>
                                        </a>
                                    </li>
                                    <li className={'menu-item menu-item-submenu menu-item-rel'}>
                                        <a href="#" className="menu-link menu-toggle">
                                            <span className="menu-text">Açık Kaynak Projelerim</span>
                                            <i className="menu-arrow"></i>
                                        </a>
                                    </li>
                                    <li className={'menu-item menu-item-submenu menu-item-rel'}>
                ...
                <div className={'content d-flex flex-column flex-column-fluid'}>
                    <div className={'d-flex flex-column-fluid'}>
                        <div className={'container'}>
                            <div className={'card card-custom overflow-hidden position-relative mb-8'} style={{height: 522}}>
                                <div className={'position-absolute bottom-0 left-0 right-0 d-none d-lg-flex flex-row-fluid'}>
									<span className="svg-icon svg-icon-full flex-row-fluid svg-icon-dark opacity-3">
										...
										<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px"
                                             viewBox="0 0 1200 172" style={{enableBackground: "0 0 1200 172"}}
                                             xmlSpace="preserve">
<path className="st0" d="M2058,94c0,0,16-14,73-14s153,92,248,92s286-145,456-145s183,34,292,34s131-54,131-54v172H2058V94z"></path>
<path className="st0" d="M0,87c0,0,16-14,73-14s153,92,248,92S607,20,777,20s183,34,292,34s131-54,131-54v172H0V87z"></path>
</svg>
										</span>
                                </div>
                                <div className={'position-absolute d-flex top-0 right-0 offset-lg-5 col-lg-7 opacity-30 opacity-lg-100'}>
                                    <span className="svg-icon svg-icon-full flex-row-fluid p-15">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" id="e66d77ca-31e8-442d-a5de-b801817c4280"
                                             data-name="Layer 1" width="1024.7" height="671.65" viewBox="0 0 1024.7 671.65">
												...
												<g opacity="0.5">
													<path
                                                        ...
                                                        transform="translate(-87.65 -114.18)" fill="url(#fd39efba-8078-41b8-857e-e17431406f47)"></path>
												</g>
												<path
												...
												<path d="M829.45,524.94s11.77,18.28,8.4,32.5C837.85,557.44,851.3,535.09,829.45,524.94Z" transform="translate(-87.65 -114.18)"
												...
												<rect x="372.13" y="350.43" width="91.92" height="5.2" transform="translate(-155.26 -13.18) rotate(-12.75)" fill="#6c63ff"
                                                      opacity="0.3"></rect>
												<rect x="373.89" y="354.04" width="166.5" height="5.2" transform="translate(-155.1 -4.47) rotate(-12.75)" fill="#6c63ff"
                                                      opacity="0.3"></rect>
												<rect x="376.57" y="365.88" width="166.5" height="5.2" transform="translate(-157.64 -3.59) rotate(-12.75)" fill="#6c63ff"
                                                      opacity="0.3"></rect>
												<rect x="379.4" y="379.06" width="154.36" height="5.2" transform="translate(-160.63 -3.98) rotate(-12.75)" fill="#6c63ff"
                                                      opacity="0.3"></rect>
												<rect x="381.93" y="389.56" width="166.5" height="5.2" transform="translate(-162.74 -1.82) rotate(-12.75)" fill="#6c63ff"
                                                      opacity="0.3"></rect>
												<rect x="385.59" y="410.21" width="86.72" height="5.2" transform="translate(-168.19 -9.31) rotate(-12.75)" fill="#6c63ff"
                                                      opacity="0.3"></rect>
												<rect x="221.62" y="391.43" width="100.59" height="69.38" transform="translate(-175 -43.64) rotate(-12.75)" fill="#f5f5f5"></rect>
												<rect x="337.76" y="165.98" width="100.59" height="69.38" transform="translate(-122.37 -23.57) rotate(-12.75)" fill="#6c63ff"
                                                      opacity="0.3"></rect>
												<rect x="433.79" y="236.72" width="100.59" height="69.38" transform="translate(-135.62 -0.63) rotate(-12.75)" fill="#6c63ff"
                                                      opacity="0.3"></rect>
												<rect x="410.68" y="203.79" width="213.27" height="308.72" rx="13.44" transform="translate(-153.95 8.85) rotate(-12.75)"
                                                      fill="url(#af3e6cbd-120e-45f3-bb1d-3967e91ae903)"></rect>
												<rect x="412.36" y="207.74" width="207.97" height="302.01" rx="13.44" transform="translate(-154.1 8.65) rotate(-12.75)"
                                                      fill="#6c63ff"></rect>
												<g opacity="0.5">
												...
												<g opacity="0.5">
													<path
                                                        ...
                                                        transform="translate(346.54 1040.57) rotate(-73.39)" fill="url(#ad46d94a-2a5e-454e-b2ea-f38dffec9c1a)"></path>
												</g>
												<rect x="911.41" y="140.66" width="161.02" height="290.64" rx="13.64" transform="translate(35.53 -385.86) rotate(16.61)"
                                                      fill="#fff"></rect>
												<path
												...
												<rect x="1010.74" y="156.59" width="35.88" height="2.24" rx="1.12" transform="translate(-5.15 -389.83) rotate(15.89)"
                                                      fill="#dbdbdb"></rect>
                                ...
                                <div className={'class="card-body d-flex justify-content-center flex-column col-lg-6 px-8 py-20 px-lg-20 py-lg-40"'}>
                                    <h2 className={'text-dark font-weight-bolder mb-8'}>
                                        Can Acar
                                    </h2>
                                    <span className="text-muted font-weight-bold mr-2">Software Architect & Software Developer</span>
                                </div>
                ...
                <div className={'footer bg-white py-4 d-flex flex-lg-column'}>
                    <div className={'container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between'}>
                        <div className={'text-dark order-2 order-md-1'}>
                            <span className="text-muted font-weight-bold mr-2">2021© Can Acar</span>
                            <a href="http://keenthemes.com/metronic" target="_blank" className="text-dark-75 text-hover-primary">via Keenthemes</a>
                        </div>
                    </div>
                </div>
            </div>
