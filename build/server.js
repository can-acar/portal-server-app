...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "25ed5809dfbca3e73e3f";
...
/*!***************************!*\
  !*** ./build/assets.json ***!
  \***************************/
/*! exports provided: client, runtime~client, vendors, , default */
/***/ (function(module) {

module.exports = JSON.parse("{\"client\":{\"js\":\"http://localhost:3001/static/js/client.chunk.js\"},\"runtime~client\":{\"js\":\"http://localhost:3001/static/js/runtime~client.js\"},\"vendors\":{\"js\":\"http://localhost:3001/static/js/vendors.chunk.js\"},\"\":{\"json\":[\"http://localhost:3001/..\\\\chunks.json\",\"http://localhost:3001/..\\\\manifest.json\"]}}");
...
/***/ "./src/app/commons/configureAppStore.js":
/*!**********************************************!*\
  !*** ./src/app/commons/configureAppStore.js ***!
  \**********************************************/
...
/* harmony import */ var _clarketm_saga_monitor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @clarketm/saga-monitor */ "@clarketm/saga-monitor");
/* harmony import */ var _clarketm_saga_monitor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_clarketm_saga_monitor__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _rootReducer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./rootReducer */ "./src/app/commons/rootReducer.js");
/* harmony import */ var _saga__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../saga */ "./src/app/saga/index.js");
...
var defaultConfig = {
  ...
  // default color
  rootSagaStart: true,
  // show root saga start effect
  effectTrigger: true,
  // show triggered effects
  effectResolve: true,
  // show resolved effects
  effectReject: true,
  // show rejected effects
  effectCancel: true,
  // show cancelled effects
...
var sagaMiddleware = redux_saga__WEBPACK_IMPORTED_MODULE_3___default()(function (options) {
  if (true) {
    options.sagaMonitor = _clarketm_saga_monitor__WEBPACK_IMPORTED_MODULE_4___default()(defaultConfig);
  }
...
var bindMiddleware = function bindMiddleware() {
  ...
  if (true) {
    return Object(redux_devtools_extension__WEBPACK_IMPORTED_MODULE_2__["composeWithDevTools"])(redux__WEBPACK_IMPORTED_MODULE_1__["applyMiddleware"].apply(void 0, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(middleware.concat(loggerMiddleware))));
  }

  return Object(redux__WEBPACK_IMPORTED_MODULE_1__["compose"])(redux__WEBPACK_IMPORTED_MODULE_1__["applyMiddleware"].apply(void 0, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(middleware)));
};

var configureAppStore = function configureAppStore(preloadedState) {
  var rootStore = Object(_rootReducer__WEBPACK_IMPORTED_MODULE_6__["rootReducer"])(preloadedState);
  var middleware = bindMiddleware([sagaMiddleware]);
  var store = Object(redux__WEBPACK_IMPORTED_MODULE_1__["createStore"])(rootStore, preloadedState, middleware);
  store.asyncReducers = {};

  store.injectReducer = function (key, reducer) {
    if (Object.hasOwnProperty.call(store.asyncReducers, key)) return;
    store.asyncReducers[key] = reducer;
    store.replaceReducer(Object(_rootReducer__WEBPACK_IMPORTED_MODULE_6__["rootReducer"])(store.asyncReducers));
  };
  ...
  store.runSagaTask = function () {
    store.sagaTask = sagaMiddleware.run(_saga__WEBPACK_IMPORTED_MODULE_7__["default"], store.getState());
    return store;
  };
...
/* harmony default export */ __webpack_exports__["default"] = (configureAppStore);

/***/ }),

/***/ "./src/app/commons/rootReducer.js":
/*!****************************************!*\
  !*** ./src/app/commons/rootReducer.js ***!
  \****************************************/
...
/* harmony import */ var _reducers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../reducers */ "./src/app/reducers/index.js");
...
var rootReducer = function rootReducer(asyncReducers) {
  return Object(_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__["combineReducers"])(_objectSpread(_objectSpread({}, asyncReducers), _reducers__WEBPACK_IMPORTED_MODULE_2__["default"]));
};

/***/ }),

/***/ "./src/app/commons/router.js":
/*!***********************************!*\
  !*** ./src/app/commons/router.js ***!
  \***********************************/
/*! exports provided: routerStore, fetchRoute */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var initialState = {};
var routerStore = Object(_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_3__["createReducer"])(initialState, (_createReducer = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(_createReducer, 'PUSH', function PUSH(state, _ref) {
  var payload = _ref.payload;
  return _objectSpread(_objectSpread({}, state), payload);
}), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(_createReducer, 'SUCCESS', function SUCCESS(state, _ref2) {
  var payload = _ref2.payload;
  return _objectSpread(_objectSpread({}, state), payload);
}), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(_createReducer, 'FAILED', function FAILED(state, _ref3) {
  var payload = _ref3.payload;
  return _objectSpread(_objectSpread(_objectSpread({}, state), payload), {}, {
    error: true
  });
}), _createReducer));
var fetchRoute = /*#__PURE__*/function () {
  var _ref4 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(request, callback) {
    var _request$_parsedUrl, hash, url, query, path, pathname, params;

    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _request$_parsedUrl = request._parsedUrl, hash = _request$_parsedUrl.hash, url = _request$_parsedUrl.url, query = _request$_parsedUrl.query, path = _request$_parsedUrl.path, pathname = _request$_parsedUrl.pathname;
            params = qs__WEBPACK_IMPORTED_MODULE_4___default.a.parse(request.query);
            return _context.abrupt("return", callback(Object.assign({}, initialState, {
              hash: hash,
              query: query,
              pathname: pathname,
              params: params,
  ...
  return function fetchRoute(_x, _x2) {
...
/* harmony import */ var _containers_main_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../containers/main/index */ "./src/app/containers/main/index.js");


var routes = [{
  path: '/',
  component: _containers_main_index__WEBPACK_IMPORTED_MODULE_1__["App"],
  exact: true,
  role: [1]
}];
...
var App = function App() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["createElement"](react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], {
    ...
    className: "starter-template text-center py-5 px-3",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19,
      columnNumber: 17
  ...
  }, "Bootstrap starter template"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("p", {
    className: "lead",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21,
  ...
  }, "Use this document as a way to quickly start any new project.", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("br", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21,
      columnNumber: 101
    }
  }), " All you get is this text and a mostly barebones HTML document.")))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("footer", {
...
/***/ "./src/app/containers/notfound/index.js":
/*!**********************************************!*\
  !*** ./src/app/containers/notfound/index.js ***!
  \**********************************************/
...
var _jsxFileName = "D:\\Projects\\portal-server-app\\src\\app\\containers\\notfound\\index.js";
...
/* harmony import */ var _commons_routes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./commons/routes */ "./src/app/commons/routes.js");
...
/* harmony import */ var _containers_notfound_index__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./containers/notfound/index */ "./src/app/containers/notfound/index.js");
...
var _jsxFileName = "D:\\Projects\\portal-server-app\\src\\app\\index.js";
...
_fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_4__["library"].add(_fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_5__["fab"], _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_6__["fas"], _fortawesome_free_regular_svg_icons__WEBPACK_IMPORTED_MODULE_7__["far"]);

var BlogRoute = function BlogRoute(_ref) {
  ...
  var isLogin = true; //auth.isLogin;

  var useHasRequiredRole = true; //roles.includes(auth.kullaniciTuru)

  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__["createElement"](react_router_dom__WEBPACK_IMPORTED_MODULE_2__["Route"], {
    exact: exact,
    path: path,
    render: function render(props) {
      return isLogin && useHasRequiredRole ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__["createElement"](Component, _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({}, props, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 27,
          columnNumber: 16
        }
      })) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__["createElement"](react_router_dom__WEBPACK_IMPORTED_MODULE_2__["Redirect"], {
        to: {
          pathname: useHasRequiredRole ? "/login" : "/yetkisizeririm",
          state: {
            //from: path
            requestedPath: path
          }
...
var App = function App() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__["createElement"](react_router_dom__WEBPACK_IMPORTED_MODULE_2__["Switch"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 43,
      columnNumber: 12
    }
  }, _commons_routes__WEBPACK_IMPORTED_MODULE_3__["default"].map(function (route) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__["createElement"](BlogRoute, _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
      key: route.path
    }, route, {
      __source: {
        fileName: _jsxFileName,
    ...
    path: "*",
    component: _containers_notfound_index__WEBPACK_IMPORTED_MODULE_8__["NotFound"],
    __source: {
      fileName: _jsxFileName,
      lineNumber: 45,
      columnNumber: 9
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _commons_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../commons/router */ "./src/app/commons/router.js");

/* harmony default export */ __webpack_exports__["default"] = ({
  router: _commons_router__WEBPACK_IMPORTED_MODULE_0__["routerStore"]
});

/***/ }),

/***/ "./src/app/saga/index.js":
/*!*******************************!*\
  !*** ./src/app/saga/index.js ***!
  \*******************************/
/*! exports provided: default */
...
/*!*****************************************!*\
  !*** external "@clarketm/saga-monitor" ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = require("@clarketm/saga-monitor");
